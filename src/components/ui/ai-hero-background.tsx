...
/**
 * AiHeroBackground — grid hexagonal de 14.400 partículas com onda pulsante.
 * Adaptado de 21st.dev para LADO ₿ (tons dourados).
 *
 * Efeitos:
 *  - Grid hexagonal com jitter (levemente aleatório)
 *  - Onda circular expansiva que "pulsa" do centro
 *  - Bloom (glow intenso nas partes brilhantes)
 *  - RGB Shift (aberração cromática sutil, cara de tech/IA)
 *
 * Cara de: scan biométrico, visualização de IA, radar de blockchain.
 */

interface AiHeroBackgroundProps {
  /** Cor das partículas. Default: dourado Bitcoin */
  color?: string;
  className?: string;
}
